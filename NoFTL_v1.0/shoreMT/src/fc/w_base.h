...
/**\brief Auto-initialized 14-byte filler for alignment of structures*/
struct fill14 {
    w_base_t::uint2_t u2[7];
    fill14() { u2[0] = u2[1] = u2[2] = u2[3] = u2[4] = u2[5] = u2[6] = u2[7] = 0; }
};

/**\brief Auto-initialized 16-byte filler for alignment of structures*/
struct fill16 {
    w_base_t::uint4_t u4[4];
    fill16() { u4[0] = u4[1] = u4[2] = u4[3] = 0; }
};
