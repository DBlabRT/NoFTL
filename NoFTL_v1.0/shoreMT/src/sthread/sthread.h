...
public:
    ...
    //Additional NAND disk IOs
    static w_rc_t    	 erase_block(int fd, int blk_num);
    static w_rc_t		 read_oob(int fd, int psn, int offset, int length, void *buf, bool with_delay);
    static w_rc_t		 write_oob(int fd, int psn, int offset, int length, void *buf, bool with_delay);
