...
public:
    ...
    virtual    w_rc_t    erase_block(int blk_num);
    virtual    w_rc_t    read_oob(int psn, int offset, int length, void *buf, bool with_delay);
    virtual    w_rc_t    write_oob(int psn, int offset, int length, void *buf, bool with_delay);
