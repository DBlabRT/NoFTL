...
#ifndef PINFO_H
#include "prec.h" // Declares partitionInfo
#endif

#ifndef HPL_INFO_H
#include "hpl_rec.h" // Declares HPL page info
#endif
...
*********************************************************************/
		...
		static rc_t      destroy_hpl_rec(const rid_t& rid);

		static rc_t      _destroy_hpl_rec(const rid_t& rid);

		static rc_t      update_hpl_field(
				const rid_t&             rid,
				const flid_t 			 fieldNumber,
				const char* 			 data,
				const Size2				dataSize);

		static rc_t      _update_hpl_field(
				const rid_t&             rid,
				const flid_t 			 fieldNumber,
				const char* 			 data,
				const Size2				dataSize);

		static rc_t      read_hpl_rec(
				const rid_t& 			 rid,
				hpl_record_t& 	 		 record);
