...
file_m::create(stid_t stid, lpid_t& first_page)
{
    ...
    cout<<"file_m::create(d) first page is  " << first_page<<endl;
	return RCOK;
}
    ...
    )
{
	...
	//*****************************************
	/// TO DO HPL- set record/page type 
    //*****************************************
...
rc_t
file_m::_alloc_page_hpl(
    stid_t fid,
    const lpid_t& near_p,
    lpid_t& allocPid,
	hpl_p &page,         // leave it fixed here
    bool search_file     // if false, it indicates strict append
)
{
    /* 
