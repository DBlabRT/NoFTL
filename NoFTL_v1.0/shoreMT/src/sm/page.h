...
public:
	...
	enum tag_t {
		...
		t_hpl_p			   = 12,		// hpl page
		t_pfile_p		   = 13			// partitionedfile page
	};
	enum page_flag_t {
	...
	virtual rc_t find_and_lock_next_slot(uint4_t space_needed, slotid_t& idx) { cout << "This method should never ever get called!" <<  endl; }

	virtual rc_t find_and_lock_free_slot(uint4_t space_needed, slotid_t& idx) { cout << "This method should never ever get called!" <<  endl; }

	virtual rc_t _find_and_lock_free_slot(bool append_only, uint4_t space_needed, slotid_t& idx) { cout << "This method should never ever get called!" <<  endl; }
