...
//extern inline int2_t hpl_div(int2_t x, int2_t devisor);
//extern inline int2_t hpl_mod(int2_t x,int2_t mod);
//extern inline int2_t hpl_func1(int2_t x,int2_t mod);
...
extern "C" void bm_print(u_char* bm, int size);
