...
public:
	...
	shipmode_to_str(temp,r->L_SHIPMODE);
                                  ...
                                  q12_input_t& in)
{
    ...
    //AGGREGATE
    tuple_filter_t* q12_agg_filter = new trivial_filter_t(sizeof(q12_tuple));
    tuple_fifo* q12_agg_buffer = new tuple_fifo(sizeof(q12_tuple));
    ...
    q12_agg_packet = new partial_aggregate_packet_t("SUM AGG",
                                                ...
                                                q12_join_packet,
                                                q12_aggregate,
						    new default_key_extractor_t(),//sizeof(int),offsetof(q12_join_tuple,L_SHIPMODE)),
    ...
    process_query(q12_agg_packet, pt);//TODO
