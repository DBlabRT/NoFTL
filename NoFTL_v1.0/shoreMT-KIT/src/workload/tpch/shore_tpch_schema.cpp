    ...
    table_desc_t("ORDERS", TPCH_ORDERS_FCOUNT, PD_NORMAL) 
{
    ...
    _desc[4].setup(SQL_FLOAT,  "O_ORDERDATE");
    ...
    table_desc_t("LINEITEM", TPCH_LINEITEM_FCOUNT, PD_NORMAL) 
{
    ...
    _desc[10].setup(SQL_FLOAT,  "L_SHIPDATE", 15);
    _desc[11].setup(SQL_FLOAT,  "L_COMMITDATE", 15);
    _desc[12].setup(SQL_FLOAT,  "L_RECEIPTDATE", 15);
