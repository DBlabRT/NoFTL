...
public:
    ...
    struct file_info_t {
        ...
        file_info_t(int nf=0, int nff=0) {
            fid = stid_t::null;
    ...
    w_rc_t get_hpl_rec_from_line(const file_info_t& finfo, hpl_record_t& hpl_rec, char* line)
    {
    	rc_t rc;
    	Size4 i = 0;
    	Size2 j;
