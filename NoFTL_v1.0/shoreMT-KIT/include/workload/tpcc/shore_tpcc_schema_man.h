...
public:
    ...
    w_rc_t wh_load_fromFile(ss_m* _pssm,
								warehouse_tuple* prwh);
...
public:
    ...
    // --- load data from a file --- //
    w_rc_t dist_load_fromFile(ss_m* _pssm,
									district_tuple* prdist);
...
public:
    ...
    // --- load data from a file --- //
    w_rc_t cust_load_fromFile(ss_m* _pssm,
							customer_tuple* prcust);
...
public:
    ...
    // --- load data from a file --- //
    w_rc_t  hist_load_fromFile(ss_m* _pssm,
						history_tuple* tuple);
...
public:
    ...
    // --- load data from a file --- //
    w_rc_t new_order_load_fromFile(ss_m* _pssm,
						new_order_tuple* tuple);
...
public:
    ...
    // --- load data from a file --- //
    w_rc_t order_load_fromFile(ss_m* _pssm, order_tuple* tuple);
...
public:
    ...
    w_rc_t ol_get_probe_iter_by_index_nl(ss_m* db,
                                         ...
                                         bool need_tuple = true);
    // --- load data from a file --- //
    w_rc_t order_line_load_fromFile(ss_m* _pssm,
						order_line_tuple* tuple);
...
public:
    ...
    // --- load data from a file --- //
    w_rc_t item_load_fromFile(ss_m* _pssm,
								item_tuple* tuple);
...
public:
    ...
    // --- load data from a file --- //
    w_rc_t st_load_fromFile(ss_m* _pssm,
								stock_tuple* tuple);
